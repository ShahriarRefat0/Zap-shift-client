...
const parcelWeight = parseFloat(data.parcelWeight)
  ...
  return (
    <div className="bg-white rounded-3xl p-15  text-black">
      <div>
        <div className="border-b border-gray-300 space-y-6 pb-6">
          <h1 className="text-5xl font-bold">Send A Parcel</h1>
          <p className="text- ">Enter Your Parcel Details</p>
        </div>
        <form
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <fieldset className="fieldset">
              <label className="label">Place Weight (kg)</label>
              <input
                type="number"
          ...
          <p className="text-sm mt-5">*PickUp Tme 4pm-7pm Approx</p>
          <input
            type="submit"
